                    ...
                    <div className="grid md:grid-cols-4 gap-8 mb-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-blue-200">
                                <li>
                                    <a href="#" className="hover:text-white hover:pl-2 transition-all inline-block">
                                        → Sewa Armada
                                    </a>
                                </li>
                                <li>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-blue-200">
                                <li>
                                    <Link href="/" className="hover:text-white hover:pl-2 transition-all inline-block">
                                        → Beranda
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/about" className="hover:text-white hover:pl-2 transition-all inline-block">
                                        → Tentang Kami
                                    </Link>
                                </li>
                                <li>
