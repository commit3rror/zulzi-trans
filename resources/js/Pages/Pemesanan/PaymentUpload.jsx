...
const PaymentUpload = () => {
    ...
    const bankOptions = {
        'Transfer Bank': { name: 'Bank BCA', rekening: '1234567890', atasNama: 'Zulzi Trans' },
        'QRIS': { name: 'QRIS', rekening: 'Scan QR Code', atasNama: 'Zulzi Trans' },
    };

    const selectedBank = bankOptions[metodeBayar] || bankOptions['Transfer Bank'];
                        ...
                        <div className="space-y-3 text-sm">
                            ...
                            <div className="pt-3 border-t border-blue-300">
                                <p className="text-xs text-gray-600 mb-2">
                                    {metodeBayar === 'Transfer Bank' ? 'Transfer ke rekening:' : 'Bayar dengan:'}
                                </p>
